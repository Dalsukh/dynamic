...
?>
<form action="merchantRegister.php">
	<?php

		$fields = array('company_name','', 'email','', 'mobile',
			'landline','merchant_type','business_type', 'address', 'city', 'state', 'country', 'pincode', 
			'latitude', 'longitude',);
