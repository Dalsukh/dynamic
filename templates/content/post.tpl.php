...
<?php
	...
	{
		$insert="Insert Into tbl_comment values('',$txt_post_id,$user_id,'".mysql_real_escape_string($txt_comment)."',0)";
...
<html>
	...
	<body bgcolor="FAF0FF">
		...
		<h3 align="Center">Please<a href="login.php"> Login</a> to Comment On Post</h3>
		<?php } ?>
		<br/><br/>
		<?php
		...
		<table align="center" width="35%">
			...
			<?php
				...
				if(isset($user_type) && $user_type=="NORMAL")
				{
				...
				while($rec=mysql_fetch_assoc($res))
				{
					...
					if(isset($user_type) && $user_type=="ADMIN" && $rec['comm_status']==0)
					echo "<A href='approve_comment.php?comment_id=".$rec['comm_id']."&action=1'> <b>Approve </b></a> ";
					else if(isset($user_type) &&$user_type=="ADMIN" && $rec['comm_status']==1)
