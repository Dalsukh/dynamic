...
function sendMail($from="parmar.dalsukh@gmail.com",$to="",$subject="")
{
	...
	$mail->Username = "parmar.dalsukh@gmail.com";

	//Password to use for SMTP authentication
	$mail->Password = "P20@DilkumaR";
...
function simpleMail($from="parmar.dalsukh@gmail.com",$to="",$subject="",$body="")
{
	...
	$to = $to;
	$subject = $subject;
	$headers = "From: Dynamic <" . strip_tags($from) . ">\r\n";
...
function getPlaceName($latitude, $longitude)
{
	...
	$data['city'] = $output->results[0]->address_components[2]->long_name;
	return $data;
}
?>
